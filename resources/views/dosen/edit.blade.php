                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select id="jurusan" class="form-control" name="jurusan" required>
                                    <option disabled
                                        {{ old('jurusan', $dosen['jurusan'] ?? '') == '' ? 'selected' : '' }}>- Pilih
                                        Jurusan -</option>
                                    <option value="Teknik Informatika"
                                        {{ old('jurusan', $dosen['jurusan'] ?? '') == 'Teknik Informatika' ? 'selected' : '' }}>
                                        Teknik Informatika</option>
                                    <option value="Sistem Informasi"
                                        {{ old('jurusan', $dosen['jurusan'] ?? '') == 'Sistem Informasi' ? 'selected' : '' }}>
                                        Sistem Informasi</option>
                                    <option value="Teknik Komputer"
                                        {{ old('jurusan', $dosen['jurusan'] ?? '') == 'Teknik Komputer' ? 'selected' : '' }}>
                                        Teknik Komputer</option>
                                    <option value="Manajemen Informatika"
                                        {{ old('jurusan', $dosen['jurusan'] ?? '') == 'Manajemen Informatika' ? 'selected' : '' }}>
